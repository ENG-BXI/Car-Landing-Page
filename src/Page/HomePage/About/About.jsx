...
const About = () => {
  return (
    <section className='container d-flex flex-column flex-sm-row gap-5 align-items-start align-items-sm-start '>
     <div className='position-relative'>
      ...
      <div>
        <h2 className='mb-3'>Machines With <br /> Future Technology</h2>
